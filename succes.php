...
<head>
  ...
  <title>Pages / Not Found 404 - SyncSources</title>
  ...
  <main>
    <div class="container">
      ...
      <section class="section error-404 min-vh-100 d-flex flex-column align-items-center justify-content-center">
        <h1>Succes :)</h1>
        <h2>Ai creeat contul cu succes.</h2>
        <a class="btn" href="login.html">Logheaza-te</a>
        <img src="assets/img/not-found.svg" class="img-fluid py-5" alt="Login">
        <div class="credits">
          ...
          Made by <a href="https://syncsources.org/">SyncSources</a>
        </div>
      </section>
